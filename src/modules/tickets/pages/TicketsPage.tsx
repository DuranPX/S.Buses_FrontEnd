    ...
    <div style={{ padding: '1rem', maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-muted, #94a3b8)', margin: 0 }}>
            Tus boletos activos listos para usar. Presenta el código QR al abordar.
          </p>
        </div>
        <button 
      ...
      {isLoading ? (
        ...
        <div style={{ textAlign: 'center', color: '#94a3b8', padding: '4rem 1rem', background: 'rgba(255,255,255,0.02)', borderRadius: '1rem', border: '1px dashed rgba(255,255,255,0.1)' }}>
          ...
          <h3 style={{ margin: '0 0 0.5rem', color: '#f8fafc' }}>No tienes boletos activos</h3>
          <p style={{ margin: '0 0 1.5rem' }}>Compra un boleto para iniciar tu próximo viaje.</p>
          <button 
            onClick={() => navigate('/rutas')}
